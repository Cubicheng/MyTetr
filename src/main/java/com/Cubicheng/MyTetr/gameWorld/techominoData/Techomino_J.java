...
public class Techomino_J extends Techomino {
    public Techomino_J() {
        techomino[0] = new Pair[]{new Pair<>(0, 0), new Pair<>(-1, 1), new Pair<>(-1, 0), new Pair<>(1, 0)};
        techomino[1] = new Pair[]{new Pair<>(0, 0), new Pair<>(1, 1), new Pair<>(0, 1), new Pair<>(0, -1)};
        techomino[2] = new Pair[]{new Pair<>(0, 0), new Pair<>(-1, 0), new Pair<>(1, 0), new Pair<>(1, -1)};
        techomino[3] = new Pair[]{new Pair<>(0, 0), new Pair<>(0, 1), new Pair<>(-1, -1), new Pair<>(0, -1)};
